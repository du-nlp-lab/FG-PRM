...
def main():
    ...
    train_dataloader = DataLoader(
            train_dataset, batch_size=args['train']['sampling_batch_size_per_card'], 
    ...
    eval_dataloader = DataLoader(
            eval_dataset, batch_size=args['train']['sampling_batch_size_per_card'], 
    ...
    reward = FineGrainedReward(
        tokenizer=tokenizer,
        calculation_error_model_ckpt=args['reward']['calculation_error_model']['ckpt'],
        fabrication_model_ckpt=args['reward']['fabrication_model']['ckpt'],
        context_inconsistency_model_ckpt=args['reward']['context_inconsistency_model']['ckpt'],
        factual_inconsistency_model_ckpt=args['reward']['factual_inconsistency_model']['ckpt'],
        instruction_inconsistency_model_ckpt=args['reward']['instruction_inconsistency_model']['ckpt'],
        logical_inconsistency_model_ckpt=args['reward']['logical_inconsistency_model']['ckpt'],
        kl_coef=args['ppo']['kl_coef'],
        calculation_error_positive_reward = args['reward']['calculation_error_model']['positive_reward'],
        calculation_error_negative_reward = args['reward']['calculation_error_model']['negative_reward'],
        fabrication_positive_reward = args['reward']['fabrication_model']['positive_reward'],
        fabrication_negative_reward = args['reward']['fabrication_model']['negative_reward'],
        context_inconsistency_positive_reward = args['reward']['context_inconsistency_model']['positive_reward'],
        context_inconsistency_negative_reward = args['reward']['context_inconsistency_model']['negative_reward'],
        factual_inconsistency_positive_reward = args['reward']['factual_inconsistency_model']['positive_reward'],
        factual_inconsistency_negative_reward = args['reward']['factual_inconsistency_model']['negative_reward'],
        instruction_inconsistency_positive_reward = args['reward']['instruction_inconsistency_model']['positive_reward'],
        instruction_inconsistency_negative_reward = args['reward']['instruction_inconsistency_model']['negative_reward'],
        logical_inconsistency_positive_reward = args['reward']['logical_inconsistency_model']['positive_reward'],
        logical_inconsistency_negative_reward = args['reward']['logical_inconsistency_model']['negative_reward'],
        sep = "</s>"
    )
    
    # prepare reward models
    reward.calculation_error_reward.f_reward_model = accelerator.prepare(
            reward.calculation_error_reward.f_reward_model)
    reward.fabrication_reward.f_reward_model = accelerator.prepare(
            reward.fabrication_reward.f_reward_model)
    reward.context_inconsistency_reward.f_reward_model = accelerator.prepare(
            reward.context_inconsistency_reward.f_reward_model)
    reward.factual_inconsistency_reward.f_reward_model = accelerator.prepare(
            reward.factual_inconsistency_reward.f_reward_model)
    reward.instruction_inconsistency_reward.f_reward_model = accelerator.prepare(
            reward.instruction_inconsistency_reward.f_reward_model)
    reward.logical_inconsistency_reward.f_reward_model = accelerator.prepare(
            reward.logical_inconsistency_reward.f_reward_model)
